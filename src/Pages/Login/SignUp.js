...
const SignUp = () => {
    ...
    if (error || googleError || updateError) {
        signInError = <p><small className='text-red-500'>{error?.message || googleError?.message || updateError?.message}</small></p>
    }
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-control w-full max-w-xs">
                            ...
                            <input {...register("name", { required: { value: true, message: 'Your name is required' } })} type="text" placeholder="Your Name" className="input input-bordered w-full max-w-xs" />
                            <label className="label">
